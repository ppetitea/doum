...
/*   Updated: 2020/01/14 10:04:29 by ppetitea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_result	initialize_ui_buttons(t_game *game)
{
	...
	// args1 = texture_args("up_white", ft_vec2i(10, 10), ft_usize(100, 100), -1);
	// args2 = texture_args("up_orange", ft_vec2i(10, 10), ft_usize(100, 100), -1);
	// if (!(add_button(game, args1, args2)))
	// 	return (throw_error("initialize_ui_button", "add button failed"));
	// args1 = texture_args("down_white", ft_vec2i(10, 105), ft_usize(100, 100), -1);
	// args2 = texture_args("down_orange", ft_vec2i(10, 105), ft_usize(100, 100), -1);
	// if (!(add_button(game, args1, args2)))
	// 	return (throw_error("initialize_ui_button", "add button failed"));
	// args1 = texture_args("brick", ft_vec2i(530, 10), ft_usize(100, 100), -1);
	// if (!(add_spawner(game, args1)))
	// 	return (throw_error("initialize_ui_spawner", "add spawner failed"));
	// args1 = texture_args("msi", ft_vec2i(425, 10), ft_usize(100, 100), -1);
	// if (!(add_spawner(game, args1)))
	// 	return (throw_error("initialize_ui_spawner", "add spawner failed"));
	// args1 = texture_args("shoot5", ft_vec2i(0, 00), ft_usize(300, 300), -1);
	// if (!(add_spawner(game, args1)))
	// 	return (throw_error("initialize_ui_spawner", "add spawner failed"));
	(void)game;
	return (OK);
