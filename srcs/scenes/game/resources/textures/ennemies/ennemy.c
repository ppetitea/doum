...
/*   Updated: 2020/01/18 23:37:50 by ppetitea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_result	load_ennemy_front_images(t_game *game)
{
...
t_result	load_ennemy_front_right_images(t_game *game)
{
	t_bitmap_texture	*bmp;
...
t_result	load_ennemy_front_left_images(t_game *game)
{
	t_bitmap_texture	*bmp;
...
t_result	load_ennemy_right_images(t_game *game)
{
	t_bitmap_texture	*bmp;
...
t_result	load_ennemy_back_images(t_game *game)
{
	t_bitmap_texture	*bmp;
...
t_result	load_ennemy_back_right_images(t_game *game)
{
	t_bitmap_texture	*bmp;
...
t_result	load_ennemy_back_left_images(t_game *game)
{
	t_bitmap_texture	*bmp;
...
t_result	load_ennemy_left_images(t_game *game)
{
	t_bitmap_texture	*bmp;
...
t_result	load_ennemy_attack_images(t_game *game)
{
	t_bitmap_texture	*bmp;
...
t_result	load_ennemy_die_images(t_game *game)
{
	t_bitmap_texture	*bmp;
