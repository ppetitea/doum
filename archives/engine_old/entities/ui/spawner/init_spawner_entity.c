...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   init_spawner_entity.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: ppetitea <ppetitea@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/01/13 04:57:16 by ppetitea          #+#    #+#             */
/*   Updated: 2020/01/20 04:56:47 by ppetitea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_result	overwrite_spawner_entity_listener(t_entity *self,
...
t_result	overwrite_spawner_entity_actions(t_entity_actions *self)
{
	...
	self->action_drag = (t_result (*)(void*))duplicate_spawner;
	self->action_select = NULL;
	self->update_texture = (t_result (*)(void*))update_spawner_texture;
	return (OK);
}